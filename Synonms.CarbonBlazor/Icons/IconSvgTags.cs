...
{
    public static string OpeningTag(int sizeInPixels, bool resizeViewBox = false) =>
        "<svg focusable=\"false\" preserveAspectRatio=\"xMidYMid meet\" aria-label=\"Icon\" aria-hidden=\"true\" viewBox=\"0 0 " + (resizeViewBox ? sizeInPixels + " " + sizeInPixels : "32 32") + "\" width=\"" + sizeInPixels + "px\" height=\"" + sizeInPixels + "px\" role=\"img\" xmlns=\"http://www.w3.org/2000/svg\">";
    ...
    public const string ArrowDownRight =
        "<title>arrow--down-right</title><polygon points=\"10 26 10 24 22.59 24 6 7.41 7.41 6 24 22.59 24 10 26 10 26 26 10 26\"/>";
    
    public const string ArrowUpRight =
        "<title>arrow--up-right</title><polygon points=\"10 6 10 8 22.59 8 6 24.59 7.41 26 24 9.41 24 22 26 22 26 6 10 6\"/>";
    ...
    public const string CaretDown =
        "<title>caret--down</title><polygon points=\"24,12 16,22 8,12 \"/>";

    public const string CaretUp =
        "<title>caret--up</title><polygon points=\"8,20 16,10 24,20 \"/>";

    public const string Caution =
        "<title>caution</title><path id=\"_Outer_Path_\" data-name=\"&lt;Outer Path&gt;\" d=\"M12.3154,12H3.6846L8,4.0884,12.3154,12M14,13,8,2,2,13Z\"/><polygon points=\"12.315 12 3.685 12 8 4.088 12.315 12\"/>";
    ...
    public const string CircleFill =
        "<title>circle--fill</title><circle cx=\"8\" cy=\"8\" r=\"6\"/>";

    public const string CircleStroke =
        "<title>circle--stroke</title><path d=\"M8,4A4,4,0,1,1,4,8,4.0045,4.0045,0,0,1,8,4M8,2a6,6,0,1,0,6,6A6,6,0,0,0,8,2Z\"/>";
    ...
    public const string Critical =
        "<title>critical</title><path d=\"M12.887,11.4727a5.9936,5.9936,0,0,0-8.36-8.3594Z\"/><path d=\"M3.113,4.5273a5.9936,5.9936,0,0,0,8.36,8.3594Z\"/>";

    public const string CriticalSeverity =
        "<title>critical--severity</title><polygon points=\"13 13 3 13 3 3 13 13\"/>";
    ...
    public const string DiamondFill =
        "<title>diamond--fill</title><path d=\"M8,2.4142,13.5858,8,8,13.5858,2.4142,8,8,2.4142M8,1,1,8l7,7,7-7L8,1Z\"/><path d=\"M8,2.4142,13.5858,8,8,13.5858,2.4142,8,8,2.4142\"/>";
    ...
    public const string HorizontalLineSolid =
        "<title>horizontal--line--solid</title><path d=\"M2,15h28v2H2v-2Z\"/>";
    ...
    public const string InformationSquareFilled =
        "<title>information--square--filled</title><path id=\"inner-path\" class=\"cls-1\" d=\"M16,8a1.5,1.5,0,1,1-1.5,1.5A1.5,1.5,0,0,1,16,8Zm4,13.875H17.125v-8H13v2.25h1.875v5.75H12v2.25h8Z\"/><path d=\"M26,4H6A2,2,0,0,0,4,6V26a2,2,0,0,0,2,2H26a2,2,0,0,0,2-2V6A2,2,0,0,0,26,4ZM16,8a1.5,1.5,0,1,1-1.5,1.5A1.5,1.5,0,0,1,16,8Zm4,16.125H12v-2.25h2.875v-5.75H13v-2.25h4.125v8H20Z\"/>";

    public const string InProgress =
        "<title>in-progress</title><path d=\"M16,2A14,14,0,1,0,30,16,14.0158,14.0158,0,0,0,16,2Zm0,26A12,12,0,0,1,16,4V16l8.4812,8.4814A11.9625,11.9625,0,0,1,16,28Z\"/>";
    ...
    public const string LowSeverity =
        "<title>low--severity</title><rect x=\"4\" y=\"4\" width=\"8\" height=\"8\"/><path d=\"M12,4v8H4V4h8m1-1H3V13H13V3Z\"/>";
    ...
    public const string PendingFilled =
        "<title>pending--filled</title><path d=\"M16,2A14,14,0,1,0,30,16,14,14,0,0,0,16,2ZM8,18a2,2,0,1,1,2-2A2,2,0,0,1,8,18Zm8,0a2,2,0,1,1,2-2A2,2,0,0,1,16,18Zm8,0a2,2,0,1,1,2-2A2,2,0,0,1,24,18Z\" transform=\"translate(0 0)\"/><path id=\"inner-path\" class=\"cls-1\" d=\"M10,16a2,2,0,1,1-2-2A2,2,0,0,1,10,16Zm6-2a2,2,0,1,0,2,2A2,2,0,0,0,16,14Zm8,0a2,2,0,1,0,2,2A2,2,0,0,0,24,14Z\" transform=\"translate(0 0)\"/>";
    ...
    public const string SquareFill =
        "<title>square--fill</title><rect x=\"3\" y=\"3\" width=\"10\" height=\"10\"/>";
    ...
    public const string UndefinedFilled =
        "<title>undefined--filled</title><path d=\"M29.391,14.527L17.473,2.609C17.067,2.203,16.533,2,16,2s-1.067,0.203-1.473,0.609L2.609,14.527C2.203,14.933,2,15.466,2,16s0.203,1.067,0.609,1.473l11.917,11.917C14.933,29.797,15.467,30,16,30s1.067-0.203,1.473-0.609l11.917-11.917C29.797,17.067,30,16.534,30,16S29.797,14.933,29.391,14.527z M21,18H11v-4h10V18z\"/><rect id=\"inner-path\" x=\"11\" y=\"14\" class=\"st0\" width=\"10\" height=\"4\"/>";

    public const string UnknownFilled =
        "<title>unknown--filled</title><path d=\"M29.391,14.527L17.473,2.609C17.067,2.203,16.533,2,16,2s-1.067,0.203-1.473,0.609L2.609,14.527C2.203,14.933,2,15.466,2,16s0.203,1.067,0.609,1.473l11.917,11.917C14.933,29.797,15.467,30,16,30s1.067-0.203,1.473-0.609l11.917-11.917C29.797,17.067,30,16.534,30,16S29.797,14.933,29.391,14.527z M16,24c-0.828,0-1.5-0.671-1.5-1.5S15.172,21,16,21s1.5,0.671,1.5,1.5S16.828,24,16,24z M17.125,17.248v1.877h-2.25V15H17c1.034,0,1.875-0.841,1.875-1.875S18.034,11.25,17,11.25h-2c-1.034,0-1.875,0.841-1.875,1.875v0.5h-2.25v-0.5C10.875,10.851,12.726,9,15,9h2c2.274,0,4.125,1.851,4.125,4.125C21.125,15.358,19.342,17.182,17.125,17.248z\"/><path id=\"inner-path\" class=\"st0\" d=\"M16,21c0.828,0,1.5,0.672,1.5,1.5S16.828,24,16,24c-0.828,0-1.5-0.672-1.5-1.5S15.172,21,16,21z M17.125,17.248c2.217-0.066,4-1.89,4-4.123C21.125,10.851,19.274,9,17,9h-2c-2.274,0-4.125,1.851-4.125,4.125v0.5h2.25v-0.5c0-1.034,0.841-1.875,1.875-1.875h2c1.034,0,1.875,0.841,1.875,1.875S18.034,15,17,15h-2.125v4.125h2.25V17.248z\"/>";
    ...
    public const string WarningAltInvertedFilled =
        "<title>warning--alt--inverted--filled</title><path id=\"inner-path\" class=\"cls-1\" d=\"M16,20a1.5,1.5,0,1,1,1.5-1.5A1.5,1.5,0,0,1,16,20Zm-1.125-5h2.25V6h-2.25Z\"/><path d=\"M27.3494,4H4.6506l-.0019.0034L15.998,25.8286h.004L27.3513,4.0034ZM14.875,6h2.25v9h-2.25ZM16,20a1.5,1.5,0,1,1,1.5-1.5A1.5,1.5,0,0,1,16,20Z\"/><path d=\"M29.855,2.481a1.001,1.001,0,0,1,.0322.98l-13,25a1,1,0,0,1-1.7744,0l-13-25A1,1,0,0,1,3,2H29A1.0007,1.0007,0,0,1,29.855,2.481ZM4.6487,4.0033,15.998,25.8286h.004L27.3513,4.0033,27.3493,4H4.6507Z\"/>";
